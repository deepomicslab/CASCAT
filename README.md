<div style="display: flex; width: 100%;">
   <img   align="left" src="doc/logo.png" alt="Model" style="width: 20%; height: auto; border-radius:40%;" /> <h1> Inferring Causal Trajectories from Spatial Transcriptomics Using CASCAT</h1>
</div>
